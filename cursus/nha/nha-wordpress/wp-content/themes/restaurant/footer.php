...
?>
    ...
    <?php //if ( ! is_404() ) : ?>
		...
		<div class="site-info">
			<a href="<?php echo esc_url( admin_url() ); ?>">Admin |</a> <a href="<?php echo esc_url( __( '', 'restaurant' ) ); ?>" title="<?php esc_attr_e( '', 'restaurant' ); ?>"><?php printf( __( 'Gemaakt door André de Groot', 'restaurant' ), '' ); ?></a>
		</div><!-- .site-info -->
	</footer><!-- #colophon -->
</div><!-- #page -->
<?php wp_footer(); ?>
